  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content" style="top: 6%;">
      <div class="modal-header">
        <h4 class="linea font-weight-bold" id="modal_titulo_propiedad"></h4>
      ...
      <div class="modal-body" style="padding-top: 0px;">
        ...
        <div class="row">
          <div class="col-lg-10 col-xl-8 wow-outer">
      ...
      <div class="modal-footer">
        ...
        <i class="fa fa-car desc" id="modal_siguiente" aria-hidden="true"></i>
        <i class="fa fa-bed desc" id="modal_previo" aria-hidden="true"></i>
      </div>
    </div>
  </div>
</div>
